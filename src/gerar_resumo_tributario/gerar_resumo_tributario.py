...
from src.ecac.relacao_pgtos.ecac_relacao_pgtos import (
    converter_relacao_pgtos_lista_planilha,
...
def create_planilha(
    ...
    dados_para_inserir_com_aba_apresentacao = (
        relacao_pgtos_para_planilha
        + [das_para_planilha[2]]
        + contribuicao_folha["valor_contribuicao"]
    )
    dados_para_inserir_somente_aba_dados = (
        faturamento
        + compras
        + contribuicao_folha["base_calculo"]
        + conta_corrente_fiscal
        + [das_para_planilha[0], das_para_planilha[1]]
    )

    planilha.inserir_colunas_mes_aba_dados(1, int(ano_inicial), 12, int(ano_final))

    planilha.insert_dados_aba_dados(dados_para_inserir_com_aba_apresentacao, True)
    planilha.insert_dados_aba_dados(dados_para_inserir_somente_aba_dados, False)
    ...
    planilha.inserir_soma_dados_na_apresentacao_por_regex(
        descricao_contains="ICMS Mensal", descricao_apresentacao="ICMS Mensal"
    )
    ...
    hora = str(data.hour).zfill(2)
    minutos = str(data.minute).zfill(2)
    output_path = f'{desktop_path}\\{"TESTE " if is_test else ""}{cnpj_numeros} resumo tributario {
        ano_inicial}_{ano_final} {dia}.{mes}.{ano} {hora}_{minutos}.xlsx'
...
def gerar_resumo_tributario(cnpj, anos, razao_social):
    ...
    try:
        ...
        msgbox(
            "Erro ao iniciar o Chrome, você precisa possuir a última versão do Chrome instalada"
        )
...
if __name__ == "__main__":
    ...
    if tipo_teste == "1":
        ...
        faturamento = [
            {
                "descricao": "FATURAMENTO - 12345678901234",
                "2023-11": 93352.92,
                "2023-12": 93352.92,
            },
            {
        ...
        compras = [
            {
                "descricao": "COMPRAS - 12345678901234",
                "2023-11": 10000.92,
                "2023-12": 20000.92,
            },
            {
                "descricao": "COMPRAS - 12345678901235",
                "2023-11": 17000.92,
                "2023-12": 15000.92,
            },
        ]
        relacao_pgtos_para_planilha = [
            {
                "descricao": "0211 - IRPF - Carnê-Leão",
                "2023-03": 100.0,
                "2023-04": 200.0,
            },
        ...
        conta_corrente_fiscal = [
            {
                "descricao": "ICMS DIF AL - 46.540.315/0003-94",
                "2023-11": 0.0,
                "2023-12": 0.0,
                "2024-01": 0.0,
                "2024-02": 0.0,
            ...
            {
                "descricao": "ICMS Mensal - 46.540.315/0003-94",
                "2024-03": 10674.46,
                "2023-01": 1000.0,
                "2023-02": 2000.0,
                "2023-03": 3000.0,
            ...
            {
                "descricao": "ICMS - Fundo Combate a Pobresa - 46.540.315/0003-94",
                "2023-01": 1000.0,
                "2023-02": 2000.0,
                "2023-03": 3000.0,
                "2023-04": 4000.0,
            ...
            {
                "descricao": "ICMS DIF AL - 46.540.315/0006-37",
                "2023-12": 0.0,
                "2024-01": 0.0,
                "2024-02": 0.0,
                "2024-03": 0.0,
